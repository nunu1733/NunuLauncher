...
| 12. AI personalization context/intent exchange contract | intentは#182 planning seamへの入力に限定、planner/allocatorが最終安全配置を所有: [spec 204](./specs/204-ai-personalization-context-intent-contract/spec.md) / [Issue #204](https://github.com/nunu1733/NunuLauncher/issues/204)。候補subject (v2) とscope結合の拡張: [spec 331](./specs/331-exchange-target-scope-coupling/spec.md) / [Issue #331](https://github.com/nunu1733/NunuLauncher/issues/331) |
