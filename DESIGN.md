...
| 13. 外部agent交換workflow (External Agent Exchange) | agent内蔵せずexchange packageの送信前確認付きexportと厳格framing importのみ。framing/envelope上限/session置換確認は #205所有、payload schema/validator/sessionは #204 (gate 12) 所有。import後は既存preview/confirm/apply path必須: [spec 205](./specs/205-external-agent-exchange/spec.md) / [Issue #205](https://github.com/nunu1733/NunuLauncher/issues/205) |
