...
| MFO-17 | Confirmation renders the concrete change list (spec 195) | Rows and header counts share the `PreviewCounts` truth, groups truncate behind accessible expand actions, degraded `details == null` announces the missing list, and TalkBack / switch / 200% font-scale behavior stays accessible. |
