...
neutral scenario + Observer-visible manifest
  ...
  -> human calibration/disposition (blind preferred when an independent reviewer is available; exposure recorded)
```
...
| UVR-AC-08 | 5–10 case calibration | Two-stage reports compared with human baseline; human adjudication disposition and prior-exposure status recorded |
