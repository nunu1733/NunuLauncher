...
| `tests/organizer-instrumentation/...` | journey (a)〜(f)、legacy import、a11y（自動oracle＋実機evidence） | AC-8/9のevidence |
...
- [ ] Tests fail for the missing behavior（`ScopeConfirmed`遷移・方法選択面・origin導出・取り込み遮断・onboarding回帰）。
