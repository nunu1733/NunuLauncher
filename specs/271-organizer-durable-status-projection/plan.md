...
> Status: draft (backlog snapshot on `issue-271-spec-plan`, baseline
> `6b6bf8dd9fa0c42399185dbb13c30192f1e15962`; ported from open PR #276 branch
> where it passed phase-1 review and was accepted at `4a1b0dd9a2`. On
> `origin/main` this plan is not yet accepted; future workers must reconcile
> with PR #276 rather than duplicating the implementation lineage.)
>
> Prior review record (PR #276 lineage): Phase-1 review APPROVE,
> code-reviewer-2 session, head bcd01e915441af5ea6840ac6552783bfb162180c,
> delta b68578790f..bcd01e9154; two non-blocking implementer notes folded into
> test wording.
