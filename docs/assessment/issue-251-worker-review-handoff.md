...
- A `status: accepted` spec/bug oracle is tied to an exact commit; a plan is tied to an exact revision. Maintenance/docs-only work records why spec/plan are `N/A`.
...
- Plan revision: merged PR #244 at `0f3d1d3a8f2562be5f21ea23f3b4d2ccc53cd463`.
