...
data class OrganizerPolicyBundle(
    ...
    companion object {
        ...
        // child 7 published -v2.4 (CATEGORY_CONTIGUOUS_V1). Every strategy
        // enablement is a new semantic version/generation per ADR-0007 §8 /
        // ADR-0012 — digest-only expansion was explicitly rejected.
        const val POLICY_BUNDLE_VERSION = "organization-policy-v2.4"
