...
class FullTargetSetMaterializer {
    fun materialize(
        ...
        if (policy.version != FullOrganizationTargetPolicyVersion) return TargetMaterializationResult.Invalid
    ...
    companion object {
        const val FullOrganizationTargetPolicyVersion = "full-target-v1"
    }
}
